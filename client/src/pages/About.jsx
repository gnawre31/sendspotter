    ...
    return (
        <div className='w-screen h-screen mb-12'>
            <span className='md:w-[450px] w-[300px] flex justify-center m-auto flex-col mt-12 text-sm md:text-base '>
                ...
                <p className='mb-4'>Let us know how we can improve through an anonymous <a href='https://forms.gle/AVd3bdZXV1YHBd8t5' target="_blank" rel="noopener noreferrer" className='text-blue-500'>Google Form</a> or shoot us an email at sendspotter@gmail.com!</p>
                ...
                <span className='text-blue-500 flex flex-col mb-8'>
                    ...
                    <a href='https://www.monodsports.com'>https://www.monodsports.com</a>
                    <a href='https://momosports.ca/en/'>https://momosports.ca/en/</a>
                    <a href='https://shop.blocshop.com'>https://shop.blocshop.com</a>
                    <a href='https://climbsmartshop.com'>https://climbsmartshop.com</a>
                    <a href='https://wallnuts.store'>https://wallnuts.store</a>
